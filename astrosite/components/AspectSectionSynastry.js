...
const AspectSectionTransit = ({ horoscope, aspectsSynastry, transitHoroscope }) => {
  ...
  const evaluateAspect = (aspectType) => {
    ...
    const getAspectsObject = (type) => {
      const aspectsMap = {
        'conjunction': aspectsSynastry.conjunction,
        'opposition': aspectsSynastry.opposition,
        'square': aspectsSynastry.square,
        'trine': aspectsSynastry.trine,
        'sextile': aspectsSynastry.sextile,
        'quincunx': aspectsSynastry.quincunx,
        'quintile': aspectsSynastry.quintile,
        'semi-square': aspectsSynastry.semisquare,
        'semi-sextile': aspectsSynastry.semisextile,
        'septile': aspectsSynastry.septile
      };
              ...
              <div key={index} className="p-2">
                <div className="flex gap-2">
                  <h4 className="text-neutral/80 font-extrabold">
                    Your {aspect.transitPlanet.label} {aspect.symbol} Their {aspect.natalPlanet.label}
                  </h4>
                </div>
