...
const ChartInputFormAP = ({ onSubmit }) => {
    ...
    <div className="space-y-10">
      <div className="text-center space-y-2">
        ...
        <p className="text-secondary/80">
          enter your birth details to generate your annual profections
        </p>
      </div>
      ...
      <div className="text-center pt-8">
        <button
          ...
          className="btn btn-wide btn-lg bg-primary hover:bg-primary-focus text-base-100 
                   ...
                   transition-all duration-300"
        >
          Calculate Annual Profections Chart
        </button>
      </div>
    </div>
  );
...
export default ChartInputFormAP;
