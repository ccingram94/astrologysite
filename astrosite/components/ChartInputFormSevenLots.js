...
const ChartInputFormSevenLots = ({ onSubmit }) => {
    ...
    <div className="space-y-10">
      <div className="text-center space-y-2">
        <h2 className="text-2xl sm:text-4xl font-bold text-primary">
          Seven Lots Chart Calculator
        </h2>
        <p className="text-secondary/80">
          enter your birth details to generate your astrological lots chart
        </p>
      </div>
...
export default ChartInputFormSevenLots;
