...
const ChartInputFormSynastry = ({ onSubmit }) => {
  // Birth Details State
    ...
    <div className="space-y-10">
      <div className="text-center space-y-2">
        ...
        <p className="text-secondary/80">
          enter your details and their details to calculate your synastry chart
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-primary text-center">Your Details</h3>
        ...
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-primary text-center">Their Details</h3>
...
export default ChartInputFormSynastry;
