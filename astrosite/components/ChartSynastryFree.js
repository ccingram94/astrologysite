...
import aspectsSynastry from '../data/aspectsSynastry';
import ChartInputFormSynastry from './ChartInputFormSynastry';
import PlacementsTableSynastry from './PlacementsTableSynastry';
import PlacementsTableSynastryAspect from './PlacementsTableSynastryAspect';
...
import AspectSectionSynastry from './AspectSectionSynastry';

const ChartSynastryFree = () => {
  ...
  const AstroChartSynastry = dynamic(() => import('./AstroChartSynastry'), {
    ssr: false
  });
      ...
      <div className='flex flex-col justify-center items-center text-primary rounded-lg'>
        <div className='flex flex-row flex-wrap justify-center items-start'>
          <div className='flex flex-col justify-center items-center text-center lg:mx-4 rounded-lg'>
            <h2 className='font-extrabold text-neutral text-4xl lg:text-6xl mb-4'>Synastry Chart</h2>
            <div className='flex flex-row flex-wrap justify-center m-2'>
              <div className='flex flex-col justify-center text-center p-2 m-2 max-w-xs'>
                <h2 className='text-xl font-extrabold mt-2'>You</h2>
              ...
              <div className='flex flex-col justify-center text-center p-2 m-2 max-w-xs'>
                <h2 className='text-xl font-extrabold mt-2'>Them</h2>
                <h2 className='font-bold text-primary/80 mt-2'>
          ...
          <div className='flex flex-row flex-wrap justify-center items-center gap-8'>
            <div className='lg:mt-2 flex flex-col justify-center'>
              <AstroChartSynastry horoscope={horoscope} transitHoroscope={transitHoroscope} />
            </div>
            <div className='overflow-x-auto'>
              <PlacementsTableSynastry horoscopeA={horoscope} horoscopeB={transitHoroscope} planets={planets} />
            </div>
            <PlacementsTableSynastryAspect horoscopeA={horoscope} horoscopeB={transitHoroscope} planets={planets} />
          </div>
        </div>
        <AspectSectionSynastry horoscope={horoscope} aspectsSynastry={aspectsSynastry} transitHoroscope={transitHoroscope} />
      </div>
    )
  }
  ...
  return (
    <div className='min-h-screen bg-base-100'>
      <div className='container mx-auto px-2 py-6'>
        ...
        { !displayChart ? (
          <ChartInputFormSynastry onSubmit={handleFormSubmit} />
          ) : (
            renderHoroscopeData()
          )
        }
...
export default ChartSynastryFree;