...
const Footer = () => {
  ...
  const quickLinks = [
    { href: '/learn', label: 'Learn Astrology' },
    { href: '/zodiac-signs', label: 'Zodiac Signs' },
    { href: '/birthchart', label: 'Birth Chart' },
    { href: '/reports', label: 'Reports' },
    { href: '/horoscopes', label: 'Daily Horoscopes' },
  ];

  const services = [
    { href: '/reports', label: 'Full Birth Chart Reading' },
    { href: '/reports', label: 'Solar Return Reading' },
    { href: '/reports', label: 'Synastry Reading' },
  ...
  return (
  <footer className="bg-base-100 border-t-1 border-primary/30">
